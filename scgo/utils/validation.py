...
def validate_positive(name: str, value: float, strict: bool = False) -> None:
    ...
    Raises:
        SCGOValidationError: If value is not positive (or negative when
            ``strict`` is False).
    """
...
def validate_composition(
    ...
    Raises:
        SCGOValidationError: If composition is None, is not a list/tuple, is
            empty (when allow_empty=False), or contains non-string elements.
    """
