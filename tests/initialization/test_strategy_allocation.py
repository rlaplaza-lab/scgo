...
class TestAllocateInitializationStrategies:
    ...
    def test_template_allocations_respect_template_count(self):
    ...
    def test_allocation_with_seeds_still_capped(self):
    ...
    def test_fewer_structures_than_templates(self):
